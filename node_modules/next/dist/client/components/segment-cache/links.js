...
function rescheduleLinkPrefetch(instance) {
    ...
    if (existingPrefetchTask === null) {
        ...
        if (appRouterState !== null) {
            ...
            instance.prefetchTask = (0, _scheduler.schedulePrefetchTask)(cacheKey, treeAtTimeOfPrefetch, instance.kind === _routerreducertypes.PrefetchKind.FULL, priority);
            instance.cacheVersion = (0, _cache.getCurrentCacheVersion)();
        }
    } else {
        // We already have an old task object that we can reschedule. This is
        // effectively the same as canceling the old task and creating a new one.
        (0, _scheduler.bumpPrefetchTask)(existingPrefetchTask, priority);
    }
}
